...
float static PI = 3.14159265359; // PI 
vector<float> g; // g, m/s^2
float static c = 0.2; // Friction coefficient
float static m  = 0.2; // Object's mass, Kg
float static ht = 0.001; // Delta-time, segs


///// Dependent variables /////

float static tmax = 3.0; //Maximum time to study the projectile's motion
int N = (int) tmax/ht; // Number of iterations
vector<float> fun[2]; 
vector<float> posx_0;
vector<float> vel_0;
